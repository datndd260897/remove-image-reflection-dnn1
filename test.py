...
parser.add_argument('--dataroot', help='path to dataset', default="./samples")
parser.add_argument(
...
parser.add_argument(
    '--ns', type=str, default='7,5,5', help='number of blocks for each module')
parser.add_argument(
    '--netG', default='./model/model.pth', help="path to netG (to continue training)")
parser.add_argument(
    '--norm',
    type=str,
    default='batch',
...
parser.add_argument('--real', action='store_true', help='test real images', default=True)
parser.add_argument(
    '--iteration', type=int, default=1, help='number of iterative updates')
parser.add_argument(
